...
def get_data():
    df = pd.read_csv("../../data/processed/twitter_financial_news_topics/financial_news_topic_processed.csv")
    return df
...
if __name__ == '__main__':
    ...
    df_vec.to_csv("../../data/processed/twitter_financial_news_topics/categories_vectorized_entities.csv")
